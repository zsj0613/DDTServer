...
namespace GameServerScript.AI.NPC
{
    public class HardKingLast : ABrain
    {
        ...
        public void GoOnAngger()
        {
            if (Body.State == 1)
            {
                ((PVEGame)Game).CreateTip(0, 0, "com.mapobject.asset.wordtip75", "com.mapobject.asset.wordtip75", "Empty", 1, 1, 0, 10);
                ...
                Body.RangeAttacking(-1, Game.Map.Info.ForegroundWidth + 1, "cry", 12600, null, 1);
            ...
            else
            {
                ...
                {
                    player.AddEffect(new ContinueReduceBloodEffect(555, 2, null), 0);
                }
            }
        }
