...
namespace GameServerScript.AI.Messions
{
    public class TSSM3203 : AMissionControl
    {
        ...
        {
            m_firstBossDead = Game.CreatePhysicalObj(firstBoss.X, firstBoss.Y, "Dead", "game.crazyTank.view.Focus", "1", 1, 1, 0, 1);
        }

        public void CreateSecondBossDead()
        {
            m_seconBossDead = Game.CreatePhysicalObj(seconBoss.X, seconBoss.Y, "Dead", "game.crazyTank.view.Focus", "1", 1, 1, 0, 1);
        }
