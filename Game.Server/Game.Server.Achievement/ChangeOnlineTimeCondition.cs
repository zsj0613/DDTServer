...
namespace Game.Server.Achievement
{
	...
	{
		public ChangeOnlineTimeCondition(GamePlayer player, int type) : base(player, type)
		{
		...
		{
			this.m_player.AchievementInventory.UpdateUserAchievement(this.m_type, character.OnlineTime, 1);
		}
