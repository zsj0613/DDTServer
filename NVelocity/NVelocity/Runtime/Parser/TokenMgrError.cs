...
namespace NVelocity.Runtime.Parser
{
    ...
    public class TokenMgrError : System.ApplicationException
    {
        ...
        */
        ...
        public TokenMgrError(System.String message, int reason)
            : base(message)
        {
            errorCode = reason;
        }

        public TokenMgrError(bool EOFSeen, int lexState, int errorLine, int errorColumn, System.String errorAfter, char curChar, int reason)
