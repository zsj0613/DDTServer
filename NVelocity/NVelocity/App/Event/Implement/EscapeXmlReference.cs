...
{
    /// <summary> Escape all XML entities.</summary>
    ...
    /// <since> 1.5
    /// </since>
    public class EscapeXmlReference : EscapeReference
    {
        ...
        /// <summary> Escape all XML entities.
        /// 
        /// </summary>
        /// <param name="text">
        /// </param>
        ...
        {
            return SupportClass.StringEscapeUtils.EscapeXml(text.ToString());
        }
    }
}
