...
namespace Game.Server.Achievement
{
	...
	{
		public ChangeAgilityCondition(GamePlayer player, int type) : base(player, type)
		{
		...
		{
			this.m_player.AchievementInventory.UpdateUserAchievement(this.m_type, character.Agility, 1);
		}
