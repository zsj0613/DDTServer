...
namespace Bussiness.CenterService
{
	...
	public class CenterServiceClient : ClientBase<ICenterService>, ICenterService
	{
		...
		{
			return base.Channel.SendAreaBigBugle(playerID, areaID, nickName, msg);
		}
		public bool GameServerSendAreaBigBugle(int userid, int areaid, string nickName, string message)
		{
			return base.Channel.GameServerSendAreaBigBugle(userid, areaid, nickName, message);
		}
	}
}
