...
{
	[GeneratedCode("System.ServiceModel", "3.0.0.0"), ServiceContract(ConfigurationName = "CenterService.ICenterService")]
	public interface ICenterService
	{
		...
		bool GameServerSendAreaBigBugle(int userid, int areaid, string nickName, string message);
	}
}
